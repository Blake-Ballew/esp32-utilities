...
enum JsonVariantType
{
    ...
    JSON_VARIANT_TYPE_BOOLEAN = 1,
    JSON_VARIANT_TYPE_INTEGER = 2,
    JSON_VARIANT_TYPE_FLOAT = 3,
    JSON_VARIANT_TYPE_STRING = 4,
    JSON_VARIANT_TYPE_ARRAY = 5,
    JSON_VARIANT_TYPE_OBJECT = 6,
    JSON_VARIANT_CONFIGURABLE_BOOL = 7,
    JSON_VARIANT_CONFIGURABLE_INTEGER = 8,
    JSON_VARIANT_CONFIGURABLE_FLOAT = 9,
    JSON_VARIANT_CONFIGURABLE_STRING = 10,
    JSON_VARIANT_CONFIGURABLE_ENUM = 11,
};
