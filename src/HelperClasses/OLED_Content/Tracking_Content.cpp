...
// TimerHandle_t Tracking_Content::updateTimer = xTimerCreateStatic("Received_Messages_Content_Update_Timer", pdMS_TO_TICKS(40), pdTRUE, (void *)0, updateDisplay, &updateTimerBuffer);
// ;